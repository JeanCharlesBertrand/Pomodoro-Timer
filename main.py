...
class Timer(tk.Tk):
    def __init__(self):
        ...
        self.menubar = tk.Menu(self, bg="lightgray", fg="black")

        self.log_menu = tk.Menu(self.menubar, tearoff=0, bg="lightgray", fg="black")
        ...
        self.main_frame = tk.Frame(self, width=500, height=300, bg="lightgray")
        self.task_name_label = tk.Label(self.main_frame, text="Task Name:", bg="lightgray", fg="black", font=self.standard_font)
        self.task_name_entry = tk.Entry(self.main_frame, bg="white", fg="black", font=self.standard_font)
        self.start_button = tk.Button(self.main_frame, text="Start", bg="lightgray", fg="black", command=self.start, font=self.standard_font)
        ...
        self.pause_button = tk.Button(self.main_frame, text="Pause", bg="lightgray", fg="black", command=self.pause,
